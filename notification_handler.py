...
EXIT_REASON_MAP = {
    "sf_ema_tp": "swing_failure \u2014 EMA target hit",
    "sf_vol_sl": "swing_failure \u2014 volatility stop",
    "sf_short_ema_tp": "swing_failure short \u2014 EMA target hit",
    "sf_short_vol_sl": "swing_failure short \u2014 volatility stop",
    "momentum_fade": "Momentum fade detected",
    "willr": "Williams %R signal",
    "overbought": "Overbought signal",
    "oversold": "Oversold signal",
    "trail": "Trailing exit",
    "bounce": "Bounce captured",
    "secure": "Profit secured",
    "rsi3_spike": "RSI momentum spike",
    "extreme_rsi": "Extreme RSI",
    "multi_tf": "Multi-TF alignment",
    "bb_stretch": "Bollinger stretch",
...
def format_entry_msg(msg):
    ...
    # Order Filled
    if tag in ("swing_failure", "swing_failure_short", "claude_swing", "claude_swing_short"):
