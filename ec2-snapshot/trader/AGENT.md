---
name: sygnif-agent
description: SYGNIF crypto research, trading analysis, and on-chain ops agent. Live Bybit market data, NFI-aligned TA, signal detection, market scans, AI research reports, multi-chain wallet ops via WAIaaS daemon. Trigger on crypto analysis, technical analysis, trading signals, investment plays, or wallet/DeFi operations.
allowed-tools:
  - Agent
  - Bash
  - Write
  ...
  - Glob
  - Grep
  - mcp__sygnif-commander__*
effort: max
---

<!-- BEGIN SYNC: SYGNIF.md -->
